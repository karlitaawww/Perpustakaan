...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        $query = "INSERT INTO buku (judul, penulis, penerbit, tahun_terbit, isbn, stok, kategori) 
                  VALUES ('$judul', '$penulis', '$penerbit', '$tahun_terbit', '$isbn', $stok, '$kategori')";
            ...
            <div class="card-body">
                ...
                <form method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="kategori" name="kategori" value="<?php echo $_POST['kategori'] ?? ''; ?>">
                    </div>
                    <div class="mb-3">
