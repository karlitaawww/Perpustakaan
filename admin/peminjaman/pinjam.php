...
$query_user = "SELECT * FROM users WHERE role = 'anggota' ORDER BY username";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($id_user)) $errors[] = 'Anggota harus dipilih';
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="id_user" name="id_user" required>
                            ...
                            <?php while ($user = mysqli_fetch_assoc($result_user)): ?>
                                <option value="<?php echo $user['id_user']; ?>" <?php echo isset($_POST['id_user']) && $_POST['id_user'] == $user['id_user'] ? 'selected' : ''; ?>>
